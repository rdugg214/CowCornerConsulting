...
if i == 1 && j == 1
    ...
    flux_e = -((k_new(index+1) + k_new(index))/2) * Kxx(index) * ( (H(index+1) - H(index))/dx(index));
    flux_n_old = -((k_old(index+Nx) + k_old(index))/2) * Kzz(index) * ( (H_old(index+Nx) - H_old(index))/dz(index));
    flux_e_old = -((k_old(index+1)+  k_old(index))/2) * Kxx(index) * ( (H_old(index+1) - H_old(index))/dx(index));
...
elseif  i == 1 && j == Nx
    ...
    flux_n = -((k_new(index+Nx) + k_new(index))/2) * Kzz(index) * ( (H(index+Nx) - H(index))/dz(index));
    flux_w = -((k_new(index)+ k_new(index-1))/2) * Kxx(index) * ( (H(index-1) - H(index))/dx(index-1));
    flux_n_old = -((k_old(index+Nx) + k_old(index))/2) * Kzz(index) * ( (H_old(index+Nx) - H_old(index))/dz(index));
